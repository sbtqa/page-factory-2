...
import static ru.sbtqa.tag.qautils.strategies.MatchStrategy.*;
...
public abstract class WebElementsPage extends Page {
    ...
    protected void fillField(WebElement webElement, String text) {
        ...
        ReflectionUtil.addToReport(webElement, text);
    }
    ...
    protected void clickWebElement(WebElement webElement) {
        ...
        ReflectionUtil.addToReport(webElement, " is clicked");
    }
    ...
    protected void pressKey(WebElement webElement, Keys keyName) {
        ...
        ReflectionUtil.addToReport(webElement, " is pressed by key '" + keyName + "'");
    }
    ...
    public void select(String elementTitle, String option) throws PageException {
        WebElement webElement = PageFactoryUtils.getElementByTitle(PageContext.getCurrentPage(), elementTitle);
        if (null != option) {
            select(webElement, option, EXACT);
        }
    }
    ...
    protected void select(WebElement webElement, String option, MatchStrategy strategy) {
        ...
        ReflectionUtil.addToReport(webElement, option);
    }
    ...
    public void checkValue(String elementTitle, String text) throws PageException {
        checkValue(text, PageFactoryUtils.getElementByTitle(PageContext.getCurrentPage(), elementTitle), EXACT);
    }
    ...
    public void checkValue(String text, WebElement webElement) {
        checkValue(text, webElement, EXACT);
    }
