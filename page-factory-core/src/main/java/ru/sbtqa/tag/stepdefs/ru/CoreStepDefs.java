...
public class CoreStepDefs {
    ...
    @Когда("^(?:пользователь |он )?ожидает что значение атрибута \"([^\"]*)\" в элементе \"([^\"]*)\" (должно|не должно) содержать \"([^\"]*)\"$")
    ...
    @Когда("^(?:пользователь |он )?ожидает (\\d+) секунд(?:у)? что значение атрибута \"([^\"]*)\" в элементе \"([^\"]*)\" (должно|не должно) содержать \"([^\"]*)\"$")
    ...
    @Когда("^(?:пользователь |он )?ожидает что элемент \"([^\"]*)\" (должен|не должен) содержать текст \"([^\"]*)\"$")
    ...
    @Когда("^(?:пользователь |он )?ожидает (\\d+) секунд(?:у)? что элемент \"([^\"]*)\" (должен|не должен) содержать текст \"([^\"]*)\"$")
    ...
    @Когда("^(?:пользователь |он )?отклоняет уведомление с текстом \"([^\"]*)\"$")
