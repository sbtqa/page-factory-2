...
public class CoreStepsImpl<T extends CoreStepsImpl<T>> {
    ...
    /**
     * Check that the element's value contains specified text
     *
     * @param <E> element type
     * @param text value for check on contains
     * @param elementTitle title of the element to search
     * @return Returns itself
     * @throws PageException
     */
    public <E extends WebElement> T checkValueContains(String elementTitle, String text) throws PageException {
        E element = getElement(elementTitle);
    ...
    /**
     * Check that the element's value doesn't contain specified text
     *
     * @param <E> element type
     * @param text value for check on not contains
     * @param elementTitle title of the element to search
     * @return Returns itself
     * @throws PageException
     */
    public <E extends WebElement> T checkValueNotContains(String elementTitle, String text) throws PageException {
        E element = getElement(elementTitle);
        if (element.getText().contains(text)) {
            throw new AutotestError("'" + elementTitle + "' value contains '" + text + "'");
        }
        return (T) this;
    }
